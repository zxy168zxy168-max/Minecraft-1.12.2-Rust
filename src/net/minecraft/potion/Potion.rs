...
impl PotionMeta {
    pub const fn hasStatusIcon(&self) -> bool {
        self.statusIconIndex >= 0
    }
    pub const fn iconRect(&self) -> (i32, i32) {
        (
            self.statusIconIndex % 8 * 18,
            198 + self.statusIconIndex / 8 * 18,
        )
    }
}
...
pub const fn potion_meta(potionId: u8) -> Option<PotionMeta> {
    let meta = match potionId {
        ...
        10 => PotionMeta {
            statusIconIndex: 7,
            liquidColor: 13458603,
            beneficial: true,
        },
        11 => PotionMeta {
            statusIconIndex: 14,
            liquidColor: 10044730,
            beneficial: true,
        },
        12 => PotionMeta {
            statusIconIndex: 15,
            liquidColor: 14981690,
            beneficial: true,
        },
        13 => PotionMeta {
            statusIconIndex: 16,
