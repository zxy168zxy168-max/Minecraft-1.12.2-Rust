...
impl WorldSettings {
    ...
    pub fn enableBonusChest(mut self) -> Self {
        self.bonusChestEnabled = true;
        self
    }
    pub fn enableCommands(mut self) -> Self {
        self.commandsAllowed = true;
        self
    }
    pub fn setGeneratorOptions(mut self, options: impl Into<String>) -> Self {
        self.generatorOptions = options.into();
        self
    }
    pub const fn isBonusChestEnabled(&self) -> bool {
        self.bonusChestEnabled
    }
    ...
    pub const fn getHardcoreEnabled(&self) -> bool {
        self.hardcoreEnabled
    }
    ...
    pub const fn areCommandsAllowed(&self) -> bool {
        self.commandsAllowed
    }
    pub fn getGeneratorOptions(&self) -> &str {
        &self.generatorOptions
    }
    pub const fn getGameTypeById(id: i32) -> GameType {
        GameType::getByID(id)
    }
}
