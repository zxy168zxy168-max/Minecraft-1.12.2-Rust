...
impl SPacketUnloadChunk{
    ...
    pub fn writePacketData(&self)->RawPacket{let mut payload=Vec::with_capacity(8);write_i32_be(self.x,&mut payload);write_i32_be(self.z,&mut payload);RawPacket::new(0x1D,payload)}
