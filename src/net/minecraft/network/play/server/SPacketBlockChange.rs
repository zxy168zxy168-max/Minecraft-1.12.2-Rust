...
use crate::net::minecraft::network::PacketBuffer::{read_i64_be, read_var_i32, write_i64_be, write_var_i32, CodecError};
...
impl SPacketBlockChange {
    pub const fn new(blockPosition: BlockPos, blockState: IBlockState) -> Self { Self { blockPosition, blockState } }
...
mod tests {
    ...
    fn protocol_340_write_read_round_trip() {
        let original = SPacketBlockChange::new(BlockPos::new(-17, 64, 31), IBlockState::fromGlobalStateId((57 << 4) | 3));
