...
use crate::net::minecraft::network::PacketBuffer::{
    read_f32_be, read_u8, write_f32_be, CodecError,
};
...
impl SPacketPlayerAbilities {
    ...
    pub const fn isInvulnerable(&self) -> bool {
        self.invulnerable
    }
    pub const fn isFlying(&self) -> bool {
        self.flying
    }
    pub const fn isAllowFlying(&self) -> bool {
        self.allowFlying
    }
    pub const fn isCreativeMode(&self) -> bool {
        self.creativeMode
    }
...
mod tests {
    ...
    fn reads_mcp_flags_and_speeds() {
        ...
        let packet =
            SPacketPlayerAbilities::readPacketData(&RawPacket::new(0x2C, payload)).unwrap();
