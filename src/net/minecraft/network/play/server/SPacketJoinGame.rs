...
use crate::net::minecraft::network::PacketBuffer::{
    read_bool, read_i32_be, read_string, read_u8, write_bool, write_i32_be, write_string,
    CodecError,
};
...
impl SPacketJoinGame {
    ...
    pub fn writePacketData(&self) -> Result<RawPacket, CodecError> {
        ...
        let mut game = self.gameType.getID() as u8;
    ...
    pub const fn isHardcoreMode(&self) -> bool {
        self.hardcoreMode
    }
    ...
    pub const fn isReducedDebugInfo(&self) -> bool {
...
mod tests {
    ...
    fn join_game_writer_round_trips_source_fields() {
        let packet = SPacketJoinGame::new(
            77,
            GameType::Survival,
            false,
            0,
